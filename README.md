...
Positive-training rounds also include original general chat and prose generated by the
Teacher and Material Author. The initial plan is 50% general / 50% domain by prepared
student target tokens, with the Teacher adapting subsequent shares from observations.
Broad datasets such as Nemotron-CC, DCLM, FineWeb and Dolma inspire coverage; their data is
not downloaded or ingested. [General-material accounting](docs/COAPT.md#generated-general-material)
separates planned shares, frozen targets and verified completed exposure.
