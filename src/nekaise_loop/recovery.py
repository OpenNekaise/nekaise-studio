...
class ConfigChange(BaseModel):
    ...
    field: Literal["focus", "source_prefix", "lessons_per_round", "passage_chars", "max_seq_len", "learning_rate", "tokens_per_update", "train_epochs", "train_steps", "max_stage_seconds", "inherit_optimizer", "restore_base_from_round", "generation_batch_size", "generation_batch_tokens", "workload_guidance", "material_authors", "remove_material_author_ids", "material_review_policy", "general_material_policy", "student_identity", "teacher_provider", "teacher_model"]
