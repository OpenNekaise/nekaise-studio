...
def setup_loop(tmp_path, corpus):
    ...
    config = CampaignConfig(expansion_policy="legacy_optional", general_material_policy="legacy_optional", student_model=str(base), corpus_path=str(corpus), rounds=2, lessons_per_round=2, eval_questions=2, train_steps=3, auto_recover=False, manage_history=False)
